defmodule Noizu.RuleEngine.Op.StrictAndOp do
  @type t :: %__MODULE__{
    name: String.t | nil,
...
defimpl Noizu.RuleEngine.ScriptProtocol, for: Noizu.RuleEngine.Op.StrictAndOp do
  ...
  def execute!(:short_circuit, this, state, context, options) do
    ...
    cond do
      ...
      true -> Enum.reduce(this.arguments, {true, state}, fn(child, {o, s}) ->
        cond do
          o == true -> Noizu.RuleEngine.ScriptProtocol.execute!(child, s, context, options)
          true -> {o, s}
        end
      end)
    end
  ...
  # render/3
  #---------------------
  def render(this, state, context), do: Helper.render_arg_list("STRICT_AND", identifier(this, state, context), this.arguments || [], state, context, %{})

  #---------------------
  # render/4
  #---------------------
  def render(this, state, context, options), do: Helper.render_arg_list("STRICT_AND", identifier(this, state, context, options), this.arguments || [], state, context, options)
end